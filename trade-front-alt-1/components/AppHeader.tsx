          ...
          <div className="ml-auto flex shrink-0 items-center gap-0.5 sm:gap-1">
            ...
            {user ? (
              <>
                ...
                <Link
                  href="/portfolio"
                  className="hidden max-w-[min(100%,14rem)] min-w-0 items-center gap-1.5 rounded-full bg-surface px-3 py-1.5 text-xs font-bold tabular-nums transition hover:bg-hover sm:inline-flex sm:px-4 sm:py-2 sm:text-sm"
                >
                  <MoneyAmount
                    amount={portfolio.balance}
                    opts={{ fractionDigits: 0 }}
